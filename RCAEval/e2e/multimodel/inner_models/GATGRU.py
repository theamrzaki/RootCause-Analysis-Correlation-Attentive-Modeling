...
from RCAEval.e2e.multimodel.inner_models.GAT import GATNet  
...
class GAT_GRU(nn.Module):
    def __init__(self, num_f, dim_with_c, num_channel, in_dim):
        ...
        self.gat_layer = GATNet(in_c=64, hid_c=self.out_dim, out_c=20, n_heads=6)#TODO in_c needs to be dynamic
