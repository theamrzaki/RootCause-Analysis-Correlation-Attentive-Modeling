...
def create_arg_parser():
    ...
    parser.add_argument('--num_vars', type=int, default=10, help='Number of variables (default: 6)')
    ...
    parser.add_argument('--noise_scale', type=float, default=3.0, help='Noise scale (default: 1.0)')
