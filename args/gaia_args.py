...
def create_arg_parser():
    ...
    Returns:
        argparse.ArgumentParser: The argument parser for the gaia dataset.
    """
    parser = argparse.ArgumentParser(description='gaia')
    ...
    parser.add_argument('--dataset_name', type=str, default='gaia', help='Dataset name (default: gaia)')
    ...
    parser.add_argument('--encoder_gamma', type=float, default=0.2, help='Encoder gamma (default: 0.5)')
    parser.add_argument('--decoder_gamma', type=float, default=0.2, help='Decoder gamma (default: 0.5)')
    ...
    parser.add_argument('--beta', type=float, default=0.01, help='Beta (default: 0.5)')
