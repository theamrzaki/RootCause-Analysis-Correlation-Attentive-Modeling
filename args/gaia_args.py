...
def create_arg_parser():
    ...
    parser.add_argument('--num_vars', type=int, default=248, help='Number of variables (default: 101 when working with 200 files, 248 when working with all files after removing constant features)')
