...
def create_arg_parser():
    ...
    parser.add_argument('--num_log_features', type=int, default=10, help='Number of log features (default: 10)')
    parser.add_argument('--num_trace_features', type=int, default=10, help='Number of trace features (default: 10)')
