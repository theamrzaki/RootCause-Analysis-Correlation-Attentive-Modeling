...
def create_arg_parser():
    ...
    parser.add_argument('--data_dir', type=str, default="/home/db2003/Desktop/Amr/MicroService_Twin_Original/data/MSDS-pre/processed_multimodal", help='Data directory (default: ./datasets/msds)')
    ...
    parser.add_argument('--include_logs_and_traces', type=int, default=1, help='Flag for including logs and traces (default: 1)')
    parser.add_argument('--main_model', type=str, default='aerca', help='Main model to use (default: aerca)')

    # Model / data structure arguments
    parser.add_argument('--num_pods', type=int, default=5, help='Number of pods / variables (default: 5)')
    ...
    parser.add_argument('--latent_per_pod', type=int, default=8, help='Number of latent features per pod (default: 16)')
    ...
    parser.add_argument('--num_hidden_layers', type=int, default=2, help='Number of hidden layers (default: 4)')
    ...
    parser.add_argument('--plot_latent_clusters', type=int, default=0, help='Flag for plotting latent clusters (default: 0)')
    parser.add_argument('--plot_latent_reduction', type=str, default='TSNE', help='Method for latent reduction (default: TSNE)')
