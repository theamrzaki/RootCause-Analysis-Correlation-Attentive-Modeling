...
def create_arg_parser():
    ...
    parser.add_argument('--exp_name', type=str, default='', help='Experiment name (default: empty string)')
    parser.add_argument('--transformation', type=str, default='orthogonal', help='Data transformation method (default: none)', choices=['none', 'orthogonal', 'learned', 'legendre', 'laguerre', 'chebyshev', 'hermite', 'fourier'])
