...
def create_arg_parser():
    """
    Creates and returns the argument parser for the Sock dataset.

    Returns:
        argparse.ArgumentParser: The argument parser for the Sock dataset.
    """
    parser = argparse.ArgumentParser(description='Sock')

    # Dataset arguments
    parser.add_argument('--preprocessing_data', type=int, default=1, help='Flag for preprocessing data (default: 1)')
    parser.add_argument('--data_dir', type=str, default=os.path.join(os.getcwd(), 'datasets', 'Sock'), help='Data directory (default: ./datasets/Sock)')
    parser.add_argument('--num_vars', type=int, default=38, help='Number of variables (default: 10)')
    ...
    parser.add_argument('--dataset_name', type=str, default='Sock', help='Dataset name (default: Sock)')
