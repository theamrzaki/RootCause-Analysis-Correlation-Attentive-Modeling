...
dataset="gaia"
window_size_item=10
num_vars=(40 60 70) #50
lrs=("1e-4")
results_csv="RQ_2_gaia_TSE_var.csv"
...
run_deep_models() {
    ...
    local hidden_layer_size=256
                                ...
                                echo "Running:  arch=$arch | dataset=$dataset | seed=$seed | window_size=$window_size_item | num_vars=$var | lr=$lrs | main_model=$main_model | preprocessing_data=$preprocessing_data"
