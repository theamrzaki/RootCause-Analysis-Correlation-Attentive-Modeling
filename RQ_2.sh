...
dataset="swat"
results_csv="RQ_2_SWAT_RaspberryPi_power_Larger.csv"
seeds=(1 2 3) 
window_size_item=8
batch_size=512
epochs=200
...
batch_size=512
dataset="wadi"
results_csv="RQ_2_WADI_RaspberryPi_power_Larger.csv"
window_size_item=8
epochs=50
seeds=(1 2 3)
hidden_layer_size=128
...
dataset="batadal"
results_csv="RQ_2_BATADAL_RaspberryPi_power_Larger.csv"
seeds=(1 2 3) # 2 3
window_size_item=16
epochs=200
batch_size=256
